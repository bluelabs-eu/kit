...
async function render_response({
	...
	console.log('start render response');
	...
	if (options.amp) {
		...
		if (options.manifest._.entry_legacy) {
			init = `${init}
